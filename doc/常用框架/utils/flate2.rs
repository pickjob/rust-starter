...
// 
//          pub fn write<W: Write>(self, w: W, lvl: Compression) -> flate2::write::GzEncoder<W>
//          pub fn read<R: Read>(self, r: R, lvl: Compression) -> flate2::read::GzEncoder<R>
...
//      read::GzDecoder::new(r: R): GzDecoder
//      write::GzDecoder::new(w: W): GzDecoder
//      read::GzEncoder::new(r: R, level: Compression): GzEncoder
//      write::GzEncoder::new(w: W, level: Compression): GzEncoder
//      结束编码、解码:
